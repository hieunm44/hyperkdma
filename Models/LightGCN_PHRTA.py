...
class LightGCN_PHRTA(LightGCN):
    def __init__(self, user_count, item_count, teacher_user_emb, teacher_item_emb, student_dim, num_layers, Graph, user_train_mat, TAs_dims, gpu):
        """
        Parameters
        ----------
