...
class BPR_PHR(BPR):
    def __init__(self, user_count, item_count, teacher_user_emb, teacher_item_emb, student_dim, user_train_mat, gpu):
        """
        Parameters
        ----------
        ...
        # teacher embedding
        self.teacher_user_emb = nn.Embedding.from_pretrained(teacher_user_emb) # Embedding(5220, 200)
        self.teacher_item_emb = nn.Embedding.from_pretrained(teacher_item_emb) # Embedding(25182, 200)
        ...
        self.teacher_dim = self.teacher_user_emb.weight.size(1) # 200
